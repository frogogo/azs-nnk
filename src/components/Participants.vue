<template>
  <div class="pt-10 bg-white">
    <div class="container" id="participants">
      <h2
        class="text-bold text-3xl md:text-5xl leading-tight mb-12 md:mb-20 text-center"
      >
        АЗС — участники акции
      </h2>
      <div class="flex flex-col md:flex-row mb-12">
        ...
        >
          ...
          >
            <div
              class="participant relative text-grey-700 hover:text-primary-500"
              ref="participant"
            ...
            >
              ...
              <span class="text-lg font-light truncate address">
                {{ participant.address }}
              </span>
              <span
                class="close-icon"
